...
from AppModels.views import crear_equipo, director_tecnico, equipo, jugador, inicio,equipos_formulario, jugadores_formulario, directores_tecnicos_formulario
